...
(function() {
  var Ace, ArrayMath, AxesLabels, Blab, BlabCoffee, BlabPlotter, BlabPrinter, Button, CodeNodeComment, CodeNodeFunction, CoffeeCompiler, CoffeeCompilerEval, CoffeeEditor, CoffeeEval, CoffeeEvaluator, CoffeeResource, ComplexMath, CredentialsForm, CssResourceInline, CssResourceLinked, EvalBoxPlotter, FavIcon, Figure, GitHub, GithubRibbon, GoogleAnalytics, HtmlResource, ImageButton, Inspector, JsResourceInline, JsResourceLinked, JsonResource, Loader, MathJaxProcessor, NavButtons, Notes, NumericFunctions, ObjectProperty, OpenInTab, Page, PageTitle, Resource, ResourceContainers, ResourceFactory, ResourceInline, ResourceLocation, Resources, SaveButton, ScalarMath, Slide, SlideContainer, SlideDeck, SlideIndex, SlidesButton, SplitEditor, ThumbImages, TypeMath, arrayToHash, hasOwn, inspect, isArray, isBoolean, isDate, isError, isFunction, isNull, isNumber, isObject, isRegExp, isString, isUndefined, objectKeys, objectToString, reduce, stylizeNoColor, stylizeWithColor, _extend,
  ...
  */
  ...
  Ace.EditorNode = (function(_super) {
    ...
    EditorNode.prototype.create = function() {
      ...
      return new SplitEditor(this.editor);
    };
  ...
  Ace.Editor = (function() {
    ...
    function Editor(spec) {
      ...
      this.customRenderer = new Ace.CustomRenderer(this);
    }
  ...
  SplitEditor = (function() {
    ...
    SplitEditor.prototype.render = function() {
      ...
      id = this.editorContainer.attr("id");
      console.log("===Code node " + id);
      codeLines = this.node.code().split("\n");
      isComment = (function() {
        var _i, _ref, _results;
        _results = [];
        for (x = _i = 1, _ref = codeLines.length; 1 <= _ref ? _i <= _ref : _i >= _ref; x = 1 <= _ref ? ++_i : --_i) {
          _results.push(false);
        }
        return _results;
      })();
      ...
      editor = function(c, code) {
        ...
        spec = {
          container: c,
          filename: filename + Ace.CustomRenderer.tempIdx,
          lang: lang,
          code: code
        };
        ...
        setTimeout((function() {
          return ed.customRenderer.render();
        }), 1000);
        return ed.editor.onFocus = function() {
          _this.node.show(true);
          _this.splitContainer.empty();
          setTimeout((function() {
            return _this.node.focus();
          }), 100);
          return _this.node.editor.onBlur = function() {
            return _this.render();
          };
        };
      };
      flush = function(mode) {
        ...
        if (mode) {
          ...
          _this.splitContainer.append(z);
        }
        return buffer = [];
      };
      for (idx = _j = 0, _len1 = codeLines.length; _j < _len1; idx = ++_j) {
        line = codeLines[idx];
        prevMode = codeMode;
  ...
  Blab = (function() {
    ...
    function Blab() {
      ...
      this.page = new Page(this.location);
