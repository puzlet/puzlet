...
(function() {
  var Ace, ArrayMath, AxesLabels, Blab, BlabCoffee, BlabPlotter, BlabPrinter, CodeNodeComment, CodeNodeFunction, CoffeeCompiler, CoffeeCompilerEval, CoffeeEditor, CoffeeEval, CoffeeEvaluator, CoffeeResource, ComplexMath, CredentialsForm, CssResourceInline, CssResourceLinked, EvalBoxPlotter, FavIcon, Figure, GitHub, GithubRibbon, GoogleAnalytics, HtmlResource, Inspector, JsResourceInline, JsResourceLinked, JsonResource, Loader, MathJaxProcessor, Notes, NumericFunctions, ObjectProperty, Page, PageTitle, Resource, ResourceContainers, ResourceFactory, ResourceInline, ResourceLocation, Resources, SaveButton, ScalarMath, TypeMath, arrayToHash, hasOwn, inspect, isArray, isBoolean, isDate, isError, isFunction, isNull, isNumber, isObject, isRegExp, isString, isUndefined, objectKeys, objectToString, reduce, stylizeNoColor, stylizeWithColor, _extend,
