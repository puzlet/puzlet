...
(function() {
  var Ace, ArrayMath, AxesLabels, BlabCoffee, BlabPlotter, BlabPrinter, CodeNodeComment, CodeNodeFunction, CoffeeCompiler, CoffeeCompilerEval, CoffeeEditor, CoffeeEval, CoffeeEvaluator, CoffeeResource, ComplexMath, CredentialsForm, CssResourceInline, CssResourceLinked, EvalBoxPlotter, FavIcon, Figure, GitHub, GithubRibbon, GoogleAnalytics, HtmlResource, Inspector, JsResourceInline, JsResourceLinked, JsonResource, Loader, MathJaxProcessor, Notes, NumericFunctions, ObjectProperty, Page, PageTitle, Resource, ResourceContainers, ResourceFactory, ResourceInline, ResourceLocation, Resources, SaveButton, ScalarMath, TypeMath, arrayToHash, hasOwn, init, inspect, isArray, isBoolean, isDate, isError, isFunction, isNull, isNumber, isObject, isRegExp, isString, isUndefined, objectKeys, objectToString, publicInterface, reduce, stylizeNoColor, stylizeWithColor, _extend,
